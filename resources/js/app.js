...
document.addEventListener("alpine:init", () => {
    Alpine.data("explorePage", (items = [], fallbackImage = "") => ({
        ...
        matchesFilter(item) {
            ...
            if (filter === "beach") {
                return (
                    category.includes("beach") || category.includes("island")
                );
            }
        ...
        get filteredItems() {
            return this.items.filter(
                (item) => this.matchesFilter(item) && this.matchesQuery(item),
            );
        },
        ...
        get featuredItem() {
            return (
                this.filteredItems.find((item) => item.featured) ||
